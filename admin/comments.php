...
// Yorumları getir
$comments = mysqli_query($conn, "SELECT c.*, u.username, t.title as topic_title 
                               FROM comments c 
...
<head>
    ...
    <title>Yorum Yönetimi - Derdimvar</title>
    ...
    <div class="admin-container">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0"><i class="fas fa-reply-all"></i> Yorum Yönetimi</h5>
                        ...
                        <tbody>
                            <?php while ($comment = mysqli_fetch_assoc($comments)): ?>
                                <tr>
                                    ...
                                    <td><?php echo mb_substr(htmlspecialchars($comment['content']), 0, 100) . '...'; ?></td>
                                    <td><?php echo date('d.m.Y H:i', strtotime($comment['created_at'])); ?></td>
                                    <td>
                                        <form method="POST" action="" class="d-inline">
                                            <input type="hidden" name="comment_id" value="<?php echo $comment['id']; ?>">
                                            <a href="../konu.php?id=<?php echo $comment['topic_id']; ?>" class="btn btn-primary btn-sm">
